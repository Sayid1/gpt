...
const keys = computed(() => Object.keys(chat.value).reverse())
...
<template>
  <div class="h-full overflow-y-scroll">
    ...
    >
      ...
      <input ref="inputRefs" :autocomplete="false" v-show="id === editId" type="text" class="text-white outline-none bg-transparent" :value="chat[id].title">
      <div class="control">
        <template v-if="id !== editId">
          <div class="img_wrap" @click="edit(id, index)">
            <img src="../assets/edit.svg" alt="">
          </div>
          <div class="img_wrap" @click="remove(id)">
            <img src="../assets/delete.svg" alt="">
          </div>
        </template>
        <template v-else>
          <div class="img_wrap" @click="update(id)">
