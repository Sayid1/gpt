...
<template>
  <div class="h-full overflow-y-scroll">
    <Modal size="xs" v-if="isShowModal" @close="closeModal" :overlayer="true">
      ...
      <template #footer>
        <div class="flex justify-end gap-x-4">
          ...
          <button @click="removeChat" type="button" class="text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            确定
          </button>
        </div>
      </template>
    ...
    >
      ...
      <input ref="inputRefs" :autocomplete="false" v-show="id === editId" type="text" class="text-white outline-none bg-transparent w-[88%]" :value="chat[id].title">
      <div class="control">
