  ...
  <div>
    <div class="chat_content">
      ...
      <template v-else>
        ...
        <div class="content_welcome_gpt mb-10 bg-[rgb(255_255_255_/_57%)] pt-[25px] pb-[15px] px-[38px]" v-else>
          <div class="pb-[25px]" v-html="marked.parse(props.record.msg)"></div>
          <div class="flex justify-between">
            <div class="re_answer" :class="{ invisible: !props.last }">
            ...
            <div class="flex gap-x-2">
              <span class="flex text-xs items-center gap-x-1">
