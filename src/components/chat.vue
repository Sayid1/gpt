    ...
    <div class="chat_content">
      ...
      <template v-else-if="props.record.role === 'assistant'">
        ...
        <div v-else class="w-full">
          <div class="content_welcome_gpt mb-6 bg-[rgb(255_255_255_/_57%)] pt-[25px] pb-[15px] px-[38px]">
          ...
          <div
            ...
            class="mt-0.5 bg-[rgb(255_255_255_/_57%)] flex justify-center gap-x-1 items-center w-32 py-1 rounded-md text-sm"
            @click="stop">
            <span>
